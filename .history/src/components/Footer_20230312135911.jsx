  ...
  return (
    <footer className="bg-slate-50">
      <Container>
        ...
        <div className="flex flex-row-reverse justify-end items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
        ...
        <div className="bg-slate-50 py-16 sm:py-24 lg:py-32">
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-8 lg:px-8">
            ...
            <form className="w-full max-w-md lg:col-span-5 lg:pt-2">
              <div className="flex gap-x-4">
                ...
                <button
                  type="submit"
                  className="flex-none rounded-md bg-emerald-600 py-2.5 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600"
                >
                  Subscribe
                </button>
              </div>
