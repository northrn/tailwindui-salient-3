  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <div className="mx-auto flex py-6">
        <h1 className="max-w-2xl text-lg tracking-tight text-slate-700">WE USE AN UNDISCOVERED, UNIQUE STRATEGY CALLED “TRIBE 100” THAT SKYROCKETS YOUR WEBSITE CONVERSION RATES…</h1>
      </div>
