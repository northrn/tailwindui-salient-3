  ...
  tiers: [
    {
      ...
      price: { monthly: '$1500', annually: '$144' },
    ...
    },
    {
      ...
      price: { monthly: '$2500', annually: '$576' },
      mainFeatures: [
        'Advanced invoicing',
    ...
    },
    {
      ...
      price: { monthly: '$3000', annually: '$288' },
          ...
          <div className="flow-root bg-gray-900 py-16 sm:pt-32 lg:pb-0">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="relative z-10">
                <h1 className="mx-auto max-w-4xl font-display text-center text-5xl font-bold tracking-tight text-white">
                  ...
                  >
                    ...
                    {pricing.frequencies.map((option) => (
                      <RadioGroup.Option
                        ...
                        value={option}
                        className={({ checked }) =>
                          classNames(checked ? 'bg-emerald-500' : '', 'cursor-pointer rounded-full py-1 px-2.5')
                        }
                      >
                ...
                >
                  ...
                  <defs>
                    <radialGradient id="d25c25d4-6d43-4bf9-b9ac-1842a30a4867">
                      <stop stopColor="#65d5e2" />
                      <stop offset={1} stopColor="#65d5e2" />
                    </radialGradient>
                  </defs>
                </svg>
                <div
                    ...
                    <div className="p-8 lg:pt-12 xl:p-10 xl:pt-14">
                      ...
                      <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch">
                        ...
                        <a
                          ...
                          className={classNames(
                            tier.featured
                              ? 'bg-emerald-600 shadow-sm hover:bg-emerald-500 focus-visible:outline-emerald-600'
                        ...
                        >
                          {tier.mainFeatures.map((mainFeature) => (
                            <li key={mainFeature} className="flex gap-x-3 py-2">
                              <CheckIcon
                                className={classNames(
                                  tier.featured ? 'text-emerald-600' : 'text-gray-500',
                                  'h-6 w-5 flex-none'
                                )}
                                aria-hidden="true"
                              />
                                  ...
                                  <td key={tier.id} className="relative w-1/4 px-4 py-0 text-center">
                                    <span className="relative h-full w-full py-3">
                                      {typeof feature.tiers[tier.name] === 'string' ? (
                                        ...
                                        <>
                                          {feature.tiers[tier.name] === true ? (
                                            <CheckIcon className="mx-auto h-5 w-5 text-emerald-600" aria-hidden="true" />
                                          ) : (
                                            <XMarkIconMini
                                              className="mx-auto h-5 w-5 text-gray-400"
                                              aria-hidden="true"
