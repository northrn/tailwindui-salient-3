...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
        <h1 className="mx-auto max-w-4xl text-5xl font-display tracking-tight text-slate-900 sm:text-7xl">
      ...
      <div className="mx-auto flex justify-center pt-8">
        <p className="max-w-2xl font-medium text-3xl tracking-tight text-slate-700">WE USE AN UNDISCOVERED, UNIQUE STRATEGY CALLED “TRIBE 100” THAT SKYROCKETS YOUR WEBSITE CONVERSION RATES…</p>
      </div>
