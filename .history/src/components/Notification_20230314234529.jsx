...
export function Notification() {
  ...
  return (
    <>
      {showNotification && (
        <div className="pointer-events-none fixed inset-x-0 right-0 z-50 bottom-0 px-6 pt-6">
          <div className="pointer-events-auto mr-6 max-w-xl rounded-xl bg-white p-6 shadow-lg ring-1 ring-gray-900/10">
            ...
            <div className="mt-4 flex items-center gap-x-5">
              <button
                ...
                className="rounded-md bg-gray-900 px-3 py-2 text-sm font-sans text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
              >
                Accept all
              </button>
              <button type="button" className="text-sm font-sans leading-6 text-gray-900">
                Reject all
              </button>
            </div>
          </div>
