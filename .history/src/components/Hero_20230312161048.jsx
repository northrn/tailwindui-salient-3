...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl hero-header">
          Sales Systems{' '}
        <span className="relative whitespace-nowrap text-emerald-600">
          ...
          <span className="hero-subheader">made simple</span>
        </span>{' '}
        <h1 className='hero-header'>
          <h1 className='hero-text'>
        for creator & info-product businesses.
          </h1>
        </h1>
      </h1>
      ...
      <div className="mx-auto flex justify-center py-6">
        <p className="max-w-2xl text-3xl tracking-tight text-slate-700">WE USE AN UNDISCOVERED, UNIQUE STRATEGY CALLED “TRIBE 100” THAT SKYROCKETS YOUR WEBSITE CONVERSION RATES…</p>
      </div>
      <div className="mt-36 lg:mt-44">
        ...
        >
          {[
            [
              { name: 'Sophron Solutions', logo: logoTransistor },
              { name: 'NOSM Store', logo: logoTuple },
              { name: 'Lennox', logo: logoStaticKit },
            ],
            [
